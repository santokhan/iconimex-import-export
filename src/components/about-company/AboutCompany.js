      ...
      <SLayout>
        <SMain>
          <div className="max-w-2xl mx-auto relative py-4 lg:py-10">
            ...
            <SDes>
              ICON IMPORT & EXPORT is a private Owned Company Established in
              according with the Ethiopian Commercial law in 2011 G.C. Mainly
              Engaged in importing of Construction & Industrial Machines, Light
              duty & Heavy duty Vehicles and Export agricultural product to
