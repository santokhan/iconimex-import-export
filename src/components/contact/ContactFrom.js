  ...
  return (
    <SLayout>
      <div className="flex flex-wrap lg:flex-nowrap rounded-3xl bg-white p-2">
        <div className="lg:max-w-sm w-full p-6 lg:p-10 bg-[#3E2093] rounded-2xl text-white flex flex-col relative overflow-hidden bg-office">
          <div className="hidden">
            ...
            <ul className="py-12 text-gray-300 z-20">
              <li className="flex items-center gap-3 py-3">
                <i
                  className="text-[#FA949D] fa fa-phone"
                  aria-hidden="true"
                ></i>
                <a
                  href="tel:"
              ...
              <li className="flex items-center gap-3 py-3">
                <i
                  className="text-[#FA949D] fa fa-envelope"
                  aria-hidden="true"
                ></i>
                <a
  ...
  return (
    <form>
      ...
      <div className="flex justify-end w-full mt-8">
        <button
          type="submit"
          className="text-white bg-[#3E2093] hover:brightness-90 focus:ring-4 focus:outline-none focus:ring-indigo-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center"
        >
          Submit
        </button>
      </div>
